...
public class ItemAdapterRec extends RecyclerView.Adapter<ItemAdapterRec.SingleItemRowHolder> {
...
//    private SweetAlertDialog sweetAlertDialog;
    ...
    public ItemAdapterRec(Activity context, List<String> ordersList, boolean isHomeFragment) {
    ...
    @Override
    public ItemAdapterRec.SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_image, null);
        ItemAdapterRec.SingleItemRowHolder mh = new ItemAdapterRec.SingleItemRowHolder(v);
        return mh;
    }

    @Override
    public void onBindViewHolder(final ItemAdapterRec.SingleItemRowHolder holder, final int i) {
